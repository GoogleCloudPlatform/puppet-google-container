...
#       puppet apply .tools/end2end/data/delete_node_pool.pp
#
...
gcontainer_cluster { "puppet-e2e-mycluster-${cluster_id}":
  ensure     => present,
  zone       => 'us-central1-a',
...
gcontainer_node_pool { 'puppet-e2e-web-servers':
  ensure     => absent,
  cluster    => "puppet-e2e-mycluster-${cluster_id}",
  zone       => 'us-central1-a',
  project    => $project, # e.g. 'my-test-project'
  credential => 'mycred',
}
